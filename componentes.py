...
class ComponentesVentana(tk.Tk):
    ...
    def _crear_componentes_tabulador4(self, tabulador):
        ...
        def mostrar_titulo():
            messagebox.showinfo('Mas info imagem', f'Nombre imagen: {imagen.cget("file")}')
    ...
    def _crear_componentes_tabulador5(self, tabulador):
        #creamos el componente de varra de pgoreso
        ...
        #metodos para contrlar los envetos de la barra de pgoreso
        def ejecutar_barra():
            ...
            for valor in range(101):
                ...
                #actualimos la barra de progreso
        ...
        #botones para controlar los eventos de una barra de pgoreso
        ...
        boton_despues = ttk.Button(tabulador, text='Detener despues', command=detener_despues)
    ...
    def _crear_tabs(self):
        ...
        #creamos los componentes del 5 tabulador
